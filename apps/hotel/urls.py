...
Staff (prefix /rooms/manage/):
  ...
  categories/<pk>/visibility/  → CategoryVisibilityView
...
urlpatterns = [
    ...
    path("manage/categories/<int:pk>/visibility/",
         views.CategoryVisibilityView.as_view(),  name="staff_category_visibility"),
